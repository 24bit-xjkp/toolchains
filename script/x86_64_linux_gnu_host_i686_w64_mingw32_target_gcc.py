...
env = gcc.environment("14", target="i686-w64-mingw32")
...
def build() -> None:
    ...
    mingw_option = f"--host={env.target} --prefix={env.lib_prefix} --with-default-msvcrt=ucrt --enable-lib32 --disable-lib64"
    # 编译binutils
