...
def build_gcc(
    build: str, host: str, target: str, multilib: bool, gdb: bool, gdbserver: bool, modifier=None, home: str = "", num_cores: int = 0
) -> None:
    """构建gcc工具链
...
if __name__ == "__main__":
    ...
    build_gcc(build, host, target, multilib, gdb, gdbserver, modifier, home, num_cores)
