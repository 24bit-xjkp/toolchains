...
# pretty-printer所需的python脚本位于share/gcc-16.0.0/python下
# 故使用哪个libstdc++.so.6.0.33-gdb.py都不影响结果，此处选择lib64下的
python_dir  = os.path.normpath(os.path.join(current_dir, "../share/gcc-16.0.0/python"))
...
cp -r share/gcc-16.0.0 $PREFIX/share
```
...
```c++
// lib/gcc/loongarch64-linux-gnu/16.0.0/include/limits.h
#endif /* _LIMITS_H___ */
#undef MB_LEN_MAX
